...
#'       "\n")
#'   cat("Mean probability of success:",
...
#'   cat("Study Design:\n")
#'   cat("  Control group size:",
#'       object$study_parameters$n_control,
#'       "\n")
#'   cat("  Treatment group size:",
...
#'     cat("  OK: New data generated with dimensions:",
#'         dim(data_sim),
#'         "\n")
#'     
