...
cat("   - When using cached ANCOVA models, power_grid_analysis() was overriding power_args\n")
...
cat("   b) Modified power_grid_analysis() to preserve these parameters when using cached models:\n")
...
cat("   B) In power_grid_analysis.R (lines 589-606):\n")
cat("      power_args <- c(\n")
cat("        list(\n")
cat("          ...\n")
...
cat("   \n")
cat("   result <- power_grid_analysis(\n")
