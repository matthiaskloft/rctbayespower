...
output: 
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{Getting Started with rctbayespower: Bayesian Power Analysis for RCTs}
...
n_cores_demo <- parallel::detectCores() - 1 
n_sims_demo <- n_cores_demo * 20 
```
...
# Advanced Features: Custom Power Analysis
