...
#>   Estimation formula: baseline +arm
#>   Design formula: baseline +arm
#> 
#> Simulation Overview:
...
participants do I need?” The `power_analysis()` function helps
...
#>   Column names: outcome, baseline,arm
...
#> grouparm     0.50        NA     0.50     0.50   NA       NA       NA
#> 
...
#> grouparm     0.66      0.24     0.21     1.12 1.00     1967     1242
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
...
#> OK: Target parameter b_armtreat extracted successfully
...
#> Intercept      0.00        NA     0.00     0.00   NA       NA       NA
#> baseline       0.30        NA     0.30     0.30   NA       NA       NA
#> grouparm     0.60        NA     0.60     0.60   NA       NA       NA
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> sigma     1.00        NA     1.00     1.00   NA       NA       NA
...
#> grouparm     0.38      0.28    -0.17     0.93 1.00     1810     1223
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
...
#> Intercept      0.00        NA     0.00     0.00   NA       NA       NA
#> baseline       0.30        NA     0.30     0.30   NA       NA       NA
#> grouparm     0.80        NA     0.80     0.80   NA       NA       NA
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
#> sigma     1.00        NA     1.00     1.00   NA       NA       NA
...
#> grouparm     0.93      0.27     0.40     1.45 1.00     2117     1486
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
...
#> grouparm     0.87      0.30     0.28     1.47 1.00     2170     1256
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
...
#> grouparm     0.91      0.27     0.37     1.43 1.00     2186     1351
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
...
``` r
summary(grid_result)
#> Bayesian RCT Power Analysis - Detailed Summary
#> =================================================
#> 
#> Analysis Parameters:
#>   Target power - Success: 0.9 
...
priors_true_params <- c(
  ...
  set_prior("constant(0.5)", class = "b", coef = "grouparm"),
...
#>   Column names: outcome, baseline, age,arm
#> Testing design model with true parameters...
#>   Using algorithm: fixed_param
#>   Running brms::brm() with sample_prior = 'only'...
#> OK: Design model with true parameters fitted successfully
...
#>  Family: gaussian 
#>   Links: mu = identity; sigma = identity 
#> Formula: outcome ~ baseline + age +arm
...
#> grouparm     0.35      0.20    -0.03     0.74 1.00      383      325
#> 
#> Further Distributional Parameters:
#>       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
...
#> Model Information:
#>   Family: gaussian(identity) 
#>   Estimation formula: baseline + age +arm
#>   Design formula: baseline + age +arm
#> 
#> Simulation Overview:
#>   Total simulations: 105 
#>   Successful fits: 75 
