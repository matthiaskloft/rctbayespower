...
conditions <- build_conditions(
  ...
  constant = list(
    # equal allocation (must be wrapped in list())
...
results_summary <- rbind(
  power_result_meanfield@results_conditions |>
    mutate(Algorithm = "Meanfield"),
  power_result_fullrank@results_conditions |>
    mutate(Algorithm = "Fullrank"),
  power_result_sampling@results_conditions |>
