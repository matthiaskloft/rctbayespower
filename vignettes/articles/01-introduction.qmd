...
conditions <- build_conditions(
  ...
  crossed = list(
    ...
    link(
      ...
      p_sig_scs = c(0.95, boundary_pocock(alpha = .05)),
      p_sig_ftl = c(0.5, boundary_pocock(alpha = .5))
    )
  ),
  constant = list(
    # baseline effect
...
power2 <- resummarize_boundaries(power,p_sig_ftl = boundary_obf(), p_sig_scs = boundary_obf())
