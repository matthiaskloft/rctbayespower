...
report(
  x = power,
  topic = c("power", "stopping", "stopping_by_look"),
  format = "cli",
  heading_level = 3
)
```
...
power2 <- resummarize_boundaries(
  power,
  thr_dec_fut = boundary_linear(0.3, 0.5),
...
```{r}
plot(power2, type = "power_curve", interactive = FALSE)
```
