...
init_bf("rctbp-3-12", verbose = TRUE)
...
# With options:
setup_bf_python(envname = "rctbp-3-12", python_version = "3.12", cuda_version = "auto", force = TRUE)
setup_bf_python(envname = "rctbp-3-11-cpu", python_version = "3.11", cuda_version = "cpu")
...
power_bf@results_conditions |>
  select(id_cond, n_total, pwr_eff, pwr_fut)
```
