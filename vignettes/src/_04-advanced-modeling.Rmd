...
required_packages <- c("rctbayespower", "ggplot2", "dplyr")
lapply(required_packages, function(pkg) {
  if (!requireNamespace(pkg, quietly = TRUE)) {
    if (pkg == "rctbayespower") {
      # Install from local source if building vignettes
...
# Adaptive and Sequential Designs: Sequential Monitoring Framework
