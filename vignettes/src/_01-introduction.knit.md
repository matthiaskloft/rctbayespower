...
#> 2       2     300          0.3
#> 
#> Number of simulations per condition: 540 
#> Number of total simulations : 1080 
#> Parallel cores: 18 
#> 
#> Total analysis time: 1.99 minutes
...
#> [22] pkgbuild_1.4.8       here_1.0.1           RColorBrewer_1.1-3  
#> [25] pkgload_1.4.0        abind_1.4-8          miniUI_0.1.2        
#> [28] withr_3.0.2          desc_1.4.3           stats4_4.5.0        
...
#> [40] rmarkdown_2.29       generics_0.1.4       remotes_2.5.0       
#> [43] RcppParallel_5.1.10  rstudioapi_0.17.1    tzdb_0.5.0          
#> [46] sessioninfo_1.2.3    cachem_1.1.0         rstan_2.32.7        
#> [49] bayesplot_1.13.0     parallel_4.5.0       matrixStats_1.5.0   
#> [52] brms_2.22.0          vctrs_0.6.5          Matrix_1.7-3        
#> [55] jsonlite_2.0.0       hms_1.1.3            glue_1.8.0          
#> [58] codetools_0.2-20     distributional_0.5.0 stringi_1.8.7       
#> [61] gtable_0.3.6         QuickJSR_1.8.0       later_1.4.2         
#> [64] pillar_1.11.0        htmltools_0.5.8.1    Brobdingnag_1.2-9   
#> [67] brio_1.1.5           R6_2.6.1             rprojroot_2.0.4     
